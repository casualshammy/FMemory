    ...
    internal class Program
    {
        private static void Main()
        {
            ...
            Pattern[] patterns =
            {
                ...
                //Pattern.FromTextstyle("MouseoverGUID", "E8 xx xx xx xx 0F 10 xx xx 0F 11 05 ?? ?? ?? ?? E8 xx xx xx xx 0F BE D0", new LeaModifier(LeaType.CmpMinusOne)),
                ...
                //Pattern.FromTextstyle("FocusedWidget", "48 8B CB E8 xx xx xx xx 33 C9 48 39 0D ?? ?? ?? ??",  new LeaModifier(LeaType.CmpMinusOne)),
                Pattern.FromTextstyle("ObjectManager", "57 41 56 41 57 48 83 EC 30 4C 8B 05 ?? ?? ?? ??",  new LeaModifier(LeaType.CmpMinusOne)),
                ...
                //Pattern.FromTextstyle("UIFrameBase", "E8 xx xx xx xx 48 8B CD 4C 89 35 ?? ?? ?? ?? E8", new LeaModifier(LeaType.CmpMinusOne)),
                //Pattern.FromTextstyle("PlayerZoneID", "E8 xx xx xx xx 48 85 C0 0F 44 1D ?? ?? ?? ?? 8B C3", new LeaModifier(LeaType.CmpMinusOne)),
                ...
                //Pattern.FromTextstyle("IsChatAFK", "39 1D ?? ?? ?? ?? 74 xx 33 D2 49 8B CF E8", new LeaModifier(LeaType.CmpMinusOne)),
                //Pattern.FromTextstyle("ChatBuffer", "48 69 D8 B8 0C 00 00 48 8D 05 ?? ?? ?? ?? 48 03 D8 48 8D 8B E6 00 00 00", new LeaModifier(LeaType.CmpMinusOne)),
            };
